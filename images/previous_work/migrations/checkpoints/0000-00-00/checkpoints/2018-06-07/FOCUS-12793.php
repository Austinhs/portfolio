...
if (!Database::columnExists("gl_pr_slots", "fl_fund_source_1")) {
	Database::createColumn("gl_pr_slots", "fl_fund_source_1", 'char', 1);
}

if (!Database::columnExists("gl_pr_slots", "fl_fund_source_2")) {
	Database::createColumn("gl_pr_slots", "fl_fund_source_2", 'char', 1);
}

if (!Database::columnExists("gl_pr_slots", "fl_fund_source_3")) {
	Database::createColumn("gl_pr_slots", "fl_fund_source_3", 'char', 1);
}

if (!Database::columnExists("gl_pr_slots", "fl_source_perc_1")) {
	Database::createColumn("gl_pr_slots", "fl_source_perc_1", 'numeric(28,10)');
}

if (!Database::columnExists("gl_pr_slots", "fl_source_perc_2")) {
	Database::createColumn("gl_pr_slots", "fl_source_perc_2", 'numeric(28,10)');
}

if (!Database::columnExists("gl_pr_slots", "fl_source_perc_3")) {
	Database::createColumn("gl_pr_slots", "fl_source_perc_3", 'numeric(28,10)');
}
